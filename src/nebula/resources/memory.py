...
class MemoryResource:
    ...
    async def store(
        ...
        *,
        request_options: Optional[RequestOptions] = None
    ) -> Union[models.MemoryStoreProcessingResult, models.MemoryStoreSearchableResult, models.MemoryStoreFailedResult]:
        """Store a memory
        ...
        _raw = _raw["results"] if isinstance(_raw, dict) else getattr(_raw, "results", _raw)
        return _validate_response(Union[models.MemoryStoreProcessingResult, models.MemoryStoreSearchableResult, models.MemoryStoreFailedResult], _raw)
