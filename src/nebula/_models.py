...
class AwsKmsMemoryEventSignature(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    algorithm: Literal['ECDSA_SHA_256'] = Field(..., title='Algorithm')
    canonicalization: Literal['json-sort-keys-v1'] = Field(
        ..., title='Canonicalization'
    )
    key_id: str = Field(..., min_length=1, title='Key Id')
    scheme: Literal['aws-kms-detached'] = Field(..., title='Scheme')
    signed_fields: list[str] = Field(..., title='Signed Fields')
...
class Ed25519MemoryEventSignature(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    algorithm: Literal['Ed25519'] = Field(..., title='Algorithm')
    canonicalization: Literal['json-sort-keys-v1'] = Field(
        ..., title='Canonicalization'
    )
    key_id: str = Field(..., min_length=1, title='Key Id')
    scheme: Literal['eddsa-detached'] = Field(..., title='Scheme')
    signed_fields: list[str] = Field(..., title='Signed Fields')
    value: str = Field(..., min_length=1, title='Value')
...
class MemoryEventCursor(BaseModel):
    ...
    seq: int = Field(..., ge=0, title='Seq')
    stream_id: UUID = Field(..., title='Stream Id')


class MemoryEventSignature(
    RootModel[Ed25519MemoryEventSignature | AwsKmsMemoryEventSignature]
):
    root: Ed25519MemoryEventSignature | AwsKmsMemoryEventSignature = Field(
        ...,
        description='Strict detached-signature union kept as a named OpenAPI component.',
        title='MemoryEventSignature',
    )


class MemoryEventTicketResult(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    ...
    websocket_url: AnyUrl = Field(..., title='Websocket Url')


class MemoryEventTicketWrite(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    id: UUID = Field(..., description='Memory ID.', title='Id')
    memory_write_id: UUID = Field(
        ...,
        description='Opaque identity of the admitted memory write.',
        title='Memory Write Id',
    )
...
class MemoryLifecycleAckFrame(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    action: Literal['ack'] = Field(..., title='Action')
    seq: int = Field(..., ge=0, title='Seq')


class MemoryLifecycleAckedFrame(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    action: Literal['acked'] = Field(..., title='Action')
    seq: int = Field(..., ge=0, title='Seq')
...
class MemoryLifecycleErrorFrame(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    action: Literal['error'] = Field(..., title='Action')
    reason: Reason = Field(..., title='Reason')


class MemoryLifecycleHeartbeatAckFrame(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    action: Literal['heartbeat_ack'] = Field(..., title='Action')


class MemoryLifecycleHeartbeatFrame(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    action: Literal['heartbeat'] = Field(..., title='Action')


class MemoryLifecycleReadyFrame(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    action: Literal['ready'] = Field(..., title='Action')
    seq: int = Field(..., ge=0, title='Seq')
...
class Reason1(Enum):
    ...
    region_rehomed = 'region_rehomed'


class Seq(RootModel[int]):
    root: int = Field(..., ge=0, title='Seq')


class WebsocketUrl(RootModel[AnyUrl]):
    root: AnyUrl = Field(..., title='Websocket Url')


class MemoryLifecycleResetFrame(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    action: Literal['reset'] = Field(..., title='Action')
    reason: Reason1 = Field(..., title='Reason')
    seq: Seq | None = Field(None, title='Seq')
    websocket_url: WebsocketUrl | None = Field(None, title='Websocket Url')
...
class MemoryStatusWaitFor(Enum):
    searchable = 'searchable'
    fully_processed = 'fully_processed'


class MemoryStatusWaitResult(Enum):
    settled = 'settled'
    pending = 'pending'
    timed_out = 'timed_out'


class MemoryStatusWrite(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    id: UUID = Field(..., title='Id')
    memory_write_id: UUID = Field(..., title='Memory Write Id')
...
class MemoryWriteConflictPublicApiError(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    code: Literal['memory_write_conflict'] = Field(..., title='Code')
    details: None = Field(..., title='Details')
    message: str = Field(..., title='Message')
    request_id: str | None = Field(..., title='Request Id')
    type: Literal['conflict'] = Field(..., title='Type')
...
class MemoryWriteMismatchPublicApiError(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    code: Literal['memory_write_mismatch'] = Field(..., title='Code')
    details: None = Field(..., title='Details')
    message: str = Field(..., title='Message')
    request_id: str | None = Field(..., title='Request Id')
    type: Literal['conflict'] = Field(..., title='Type')
...
class RecalledTableColumn(BaseModel):
    """
    One authoritative column exposed with a recalled table artifact.
    """

    inferred_type: str = Field(..., title='Inferred Type')
    name: str = Field(..., title='Name')
...
class RecalledTableQueryFilter(BaseModel):
    """
    One validated predicate selected from the user's retrieval query.
    """

    column: str = Field(..., title='Column')
    op: Op3 = Field(..., title='Op')
...
class WrappedMemoryEventTicketResponse(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    results: MemoryEventTicketResult
...
class ListedMemoryResponse(BaseModel):
    """
    Memory as it appears in list responses, with per-row chunk-page metadata appended.
    """
    ...
    chunks_url: str | None = Field(None, title='Chunks Url')
...
class MemoryEventInboundFrame(
    RootModel[MemoryLifecycleAckFrame | MemoryLifecycleHeartbeatFrame]
):
    root: MemoryLifecycleAckFrame | MemoryLifecycleHeartbeatFrame = Field(
        ...,
        description='Strict client-to-server lifecycle WebSocket frame union.',
        discriminator='action',
        title='MemoryEventInboundFrame',
    )


class MemoryEventTicketRequest(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    collection_id: UUID = Field(..., title='Collection Id')
    cursor: MemoryEventCursor | None = None
    writes: list[MemoryEventTicketWrite] = Field(
        ..., max_length=40, min_length=1, title='Writes'
    )


class MemoryResponse(BaseModel):
    """
    Stable public representation of a memory.
    """
    ...
    chunks: list | None = Field(None, title='Chunks')
    chunks_truncated: bool | None = Field(None, title='Chunks Truncated')
    chunks_url: str | None = Field(None, title='Chunks Url')
    collection_ids: list[UUID] | None = Field(None, title='Collection Ids')
    conversation: ConversationFields | None = None
    created_at: datetime | None = Field(None, title='Created At')
    ...
    text: str | None = Field(None, title='Text')
    title: str | None = Field(None, title='Title')
    total_chunks: int | None = Field(None, title='Total Chunks')
    total_tokens: int | None = Field(None, title='Total Tokens')
    updated_at: datetime | None = Field(None, title='Updated At')
...
class MemoryStatusRequest(BaseModel):
    ...
    collection_id: UUID = Field(..., title='Collection Id')
    wait_for: MemoryStatusWaitFor
    wait_seconds: float = Field(0, ge=0.0, le=25.0, title='Wait Seconds')
    writes: list[MemoryStatusWrite] = Field(
        ..., max_length=40, min_length=1, title='Writes'
    )
...
class MemoryWriteProjection(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    failure: MemoryStoreFailure | None = None
    fully_processed: bool = Field(..., title='Fully Processed')
    id: UUID = Field(..., title='Id')
    memory_write_id: UUID = Field(..., title='Memory Write Id')
    outcome: MemoryWriteOutcome
    projection_version: int = Field(..., ge=1, title='Projection Version')
    searchable: bool = Field(..., title='Searchable')


class PaginatedListedMemoryResponse(BaseModel):
    """
    Cursor-paginated list of ListedMemoryResponse entries. The wire envelope is ``{data, next_cursor, has_more}``.
    """

    data: list[ListedMemoryResponse]
    has_more: bool = Field(
        ...,
        description='Whether another page is available after this one.',
        examples=[True],
...
class RecalledTableQuery(BaseModel):
    """
    The bounded typed query Nebula executed for a recalled table.
    """

    columns: list[str] | None = Field(None, title='Columns')
    filters: list[RecalledTableQueryFilter] | None = Field(None, title='Filters')
    limit: int = Field(..., ge=1, le=100, title='Limit')


class RecalledTableQueryRow(BaseModel):
    """
    One exact table row plus its immutable evidence reference.
    """

    evidence_ref: EvidenceRef
    row_index: int = Field(..., ge=0, title='Row Index')
...
class StoreMemoriesResult(BaseModel):
    ...
    memories: list[MemoryWriteProjection] = Field(..., title='Memories')
...
class WrappedMemoryResponse(BaseModel):
    results: MemoryResponse


class WrappedMemoryWriteProjection(BaseModel):
    results: MemoryWriteProjection
...
class ActivatedSemantic(BaseModel):
    ...
    found relevant to the query. Identifies the subject graph node the
    assertion is about, and links back to its source utterances for
    provenance.
    """
...
class MemoryLifecycleEventData(BaseModel):
    """
    The authoritative write projection at the time of publication.
    """
...
class MemoryLifecycleEventFrame(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    action: Literal['event'] = Field(..., title='Action')
    data: MemoryLifecycleEventData
    event_id: UUID = Field(..., title='Event Id')
    seq: int = Field(..., ge=0, title='Seq')
    signature: MemoryEventSignature | None = None
    type: Literal['memory.lifecycle'] = Field(..., title='Type')
...
class MemoryStatusResponse(BaseModel):
    ...
    memories: list[MemoryWriteProjection] = Field(..., title='Memories')
    pending_memory_write_ids: list[UUID] = Field(..., title='Pending Memory Write Ids')
    wait_for: MemoryStatusWaitFor
    wait_result: MemoryStatusWaitResult
...
class RecalledTableQueryResult(BaseModel):
    """
    Exact rows produced by a recalled table's automatically planned query.
    """

    artifact_id: UUID = Field(..., title='Artifact Id')
    collection_id: UUID = Field(..., title='Collection Id')
    columns: list[str] | None = Field(None, title='Columns')
    row_count: int = Field(..., ge=0, title='Row Count')
    rows: list[RecalledTableQueryRow] | None = Field(None, title='Rows')
...
class WrappedMemoryStatusResponse(BaseModel):
    results: MemoryStatusResponse
...
class MemoryEventOutboundFrame(
    RootModel[
    ...
    root: (
        ...
        discriminator='action',
        title='MemoryEventOutboundFrame',
    )


class RecalledTableArtifact(BaseModel):
    """
    A returned table that is immediately usable without another tool call.
    """

    artifact_id: UUID = Field(..., title='Artifact Id')
    collection_id: UUID = Field(..., title='Collection Id')
    columns: list[RecalledTableColumn] | None = Field(None, title='Columns')
    columns_truncated: bool = Field(False, title='Columns Truncated')
    preview: str = Field('', title='Preview')
    query: RecalledTableQuery
    query_result: RecalledTableQueryResult
    row_count: int = Field(..., ge=0, title='Row Count')
    schema_column_count: int = Field(..., ge=0, title='Schema Column Count')
    table_name: str = Field(..., title='Table Name')
...
class MemoryRecall(BaseModel):
    ...
    1. **Semantics (semantic layer)**: Structured assertions (facts,
       inferences, tasks) scored by relevance and confidence. Each item
       identifies the subject graph node it is about.

    2. **Episodes (temporal clusters)**: Episodic nodegroups that cluster
       temporally related facts and events.

    3. **Sources (episodic layer)**: The raw source material that
    ...
    table_artifact_candidate_count: int = Field(
        0, ge=0, title='Table Artifact Candidate Count'
    )
    table_artifacts: list[RecalledTableArtifact] | None = Field(
        None, title='Table Artifacts'
    )
    table_artifacts_truncated: bool = Field(False, title='Table Artifacts Truncated')
