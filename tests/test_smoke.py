...
async def test_write_calls_derive_edge_routing_headers_from_body_ids() -> None:
    ...
    def handler(request: httpx.Request) -> httpx.Response:
            ...
            return httpx.Response(
                ...
                json={
                    "results": {
                        ...
                        "memory_write_id": "aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa",
                        "outcome": "processing",
                        "searchable": False,
        ...
        if request.url.path == (
            "/v1/memories/44444444-4444-4444-8444-444444444444/append"
        ):
            return httpx.Response(
                202,
                json={
                    "results": {
                        ...
                        "memory_write_id": "bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb",
                        "outcome": "processing",
                        "searchable": False,
                        "fully_processed": False,
                        "failure": None,
...
async def test_does_not_retry_non_retryable_upload_creation() -> None:
    ...
    async with _make_client(
        ...
        with pytest.raises(NebulaServerError):
            await client.memory.create_upload(
                filename="file.txt",
        ...
        return httpx.Response(
            ...
            json={
                "results": {
                    ...
                    "memory_write_id": "99999999-9999-4999-8999-999999999999",
                    "outcome": "processing",
                    "searchable": False,
                    "fully_processed": False,
                    "failure": None,
